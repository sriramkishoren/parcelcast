...
├── data/
│   ├── sales_train_evaluation.csv      # Raw M5 — download from Kaggle (gitignored)
│   ├── calendar.csv                    # Raw M5 — download from Kaggle (gitignored)
│   ├── sell_prices.csv                 # Raw M5 — download from Kaggle (gitignored)
│   ├── model_scorecard.csv             # Generated by notebook 02 (committed)
│   ├── lag_analysis.csv                # Generated by notebook 02 (committed)
│   ├── fedex_contract_status.csv       # Generated by notebook 03 (committed)
│   ├── cost_optimization.csv           # Generated by notebook 03 (committed)
│   ├── validation_results.csv          # Generated by notebook 01 (committed)
│   ├── cleaning_audit_log.csv          # Generated by notebook 01 (committed)
│   ├── weekly_network_volumes.parquet  # Generated by notebook 01 — region × channel × carrier × week (gitignored)
│   ├── weekly_region_channel.parquet   # Generated by notebook 01 — region × channel × week (gitignored)
│   └── network_forecast.parquet        # Generated by notebook 02 — 12-week LightGBM forecast (gitignored)
├── notebooks/
...
└── presentation/                    # Saved charts for the deck (9 PNGs)
```
